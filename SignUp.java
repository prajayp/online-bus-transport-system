...
public class SignUp extends User implements ActionListener
{
	...
	public void actionPerformed(ActionEvent evt)
	{
		try
		{
			...
			String fn,ln,username,password,phone;
            fn=txt1.getText();
            ln=txt2.getText();
            phone=txt3.getText();
            ...
            st = c.createStatement(); 
             ...
             String sql = "INSERT INTO passenger VALUES('"+fn+"','"+ln+"','"+username+"','"+password+"','"+change+"');";
             String sql1= "INSERT INTO login VALUES('"+username+"','"+password+"');";
